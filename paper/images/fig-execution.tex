...
unlikely; the janitor and the release reconciler are idempotent sweeps;
\aria's plan worker polls without a claim lease. The bottom box is the one place where the model is genuinely
