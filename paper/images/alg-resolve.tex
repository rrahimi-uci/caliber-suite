...
%%
%% Short on purpose. This is the only CALIBER code that runs on the serving path,
...
deployment. Line~5 is the property that makes the resolver's failure mode
