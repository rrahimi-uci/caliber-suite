...
dispatches them, so a human must use the draft lifecycle UI/API. These two gated
paths are not yet one unified registry mechanism. The protection remains only as
