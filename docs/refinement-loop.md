...
> **New here?** Start with the [Platform](01-caliber/architecture.md) overview for the embedded and standalone topologies, then this page for *what* the canonical refinement path does, then dip into whichever artifact you're working with.
