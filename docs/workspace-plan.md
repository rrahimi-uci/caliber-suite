...
version_applicability: reviewed against origin/main at c220a946e86; the Workspace, revision, environment, release, rework, and CALIBER SDK models described as target state remain proposed except for the explicitly marked delivered slices, including P4-E's provider-neutral source-control contract, offline fake adapter, injectable GitHub REST normalizer, and durable source-event/actor-link persistence on this branch
tags:
  - workspace
  - lifecycle
  - cicd
