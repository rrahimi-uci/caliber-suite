...
version_applicability: reviewed against origin/main at c220a946e86; the Workspace, revision, environment, release, rework, and CALIBER SDK models described as target state remain proposed except for the explicitly marked delivered slices, including P4-C's provider-neutral source/import/revision API surface on this branch
tags:
  - workspace
  - lifecycle
  - cicd
