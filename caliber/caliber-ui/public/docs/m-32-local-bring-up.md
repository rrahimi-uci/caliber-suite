<!-- Generated by docs-site/build-docs.mjs from docs/operate/local-bring-up.md. Do not edit this file: edit the source and re-run the build (caliber/caliber-ui: npm run sync:docs). -->
...
| Recovery path | You need failure handling, not first boot | [Operations runbook](m-19-runbook.md) |
...
- using the product: [Choose your CALIBER path](m-30-choose-your-path.md)
- integrating programmatically: [Auth and project scoping](m-31-auth-and-project-scoping.md)
- operating and recovering: [Operator troubleshooting](m-51-operator-troubleshooting.md), [Operations runbook](m-19-runbook.md)
- validating trust and governance: [Trust and governance](m-33-trust-and-governance.md)
