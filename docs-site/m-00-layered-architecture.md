...
| Anyone asking **"what is actually built?"** | [product-completness-report.md](https://github.com/rrahimi-uci/caliber-suite/blob/main/product-completness-report.md) — the dated implementation and validation record; use the latest `main` CI run for current release evidence |
