...
const MODULES = [
  ...
  { md: "16-openapi-integrations/architecture.md", out: "m-57-openapi-integrations.html", group: "platform", label: "OpenAPI Integrations", blurb: "Governed import of third-party OpenAPI specs, deterministic operation classification and dependency detection, curated tool-draft generation, and publication into the existing tool registry through a declarative HTTP executor." },
  ...
  { md: "use/openapi-integrations.md", out: "m-58-use-openapi-integrations.html", group: "platform", label: "OpenAPI Integrations", blurb: "The practical five-step flow for importing an OpenAPI spec, curating tool drafts, and publishing governed tools from it." },
  ...
  { md: "prd.md", out: "m-59-v1-product-requirements.html", group: "strategy", label: "v1 product requirements", blurb: "The bounded product contract for CALIBER v1.0.0: target users, supported journey, non-goals, release requirements, and the trace from requirements to the GitHub delivery plan." },
