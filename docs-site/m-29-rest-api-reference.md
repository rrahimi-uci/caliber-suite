...
| `Error` | `detail`, `status_code`, `reason_code` | Rendered from HTTPException by routes/_errors.py. Required: detail, status_code. |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/change-requests/{change_request_id}:accept` | project role (`change_request.accept`) | `change_request_id`, `project_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `post_projects_project_id_change_requests_change_request_id_accept` |
...
| `PATCH` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/environments/{name}` | `caliber.operator` | `name`, `project_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `patch_projects_project_id_environments_name`; request body documented in OpenAPI |
...
| `GET` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/releases` | any authenticated user | `project_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `get_projects_project_id_releases` |
| `POST` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/releases` | any authenticated user | `project_id` | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_projects_project_id_releases`; request body documented in OpenAPI |
| `GET` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/releases/{release_id}` | any authenticated user | `project_id`, `release_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `get_projects_project_id_releases_release_id` |
| `POST` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/releases/{release_id}/approve` | any authenticated user | `project_id`, `release_id` | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_projects_project_id_releases_release_id_approve`; request body documented in OpenAPI |
| `POST` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/releases/{release_id}/break-glass-apply` | any authenticated user | `project_id`, `release_id` | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_projects_project_id_releases_release_id_break_glass_apply`; request body documented in OpenAPI |
| `POST` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/releases/{release_id}/evaluate` | any authenticated user | `project_id`, `release_id` | `202`, `400`, `401`, `403`, `404` | `operationId`: `post_projects_project_id_releases_release_id_evaluate`; request body documented in OpenAPI |
| `GET` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/releases/{release_id}/evaluations` | any authenticated user | `project_id`, `release_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `get_projects_project_id_releases_release_id_evaluations` |
| `GET` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/releases/{release_id}/evaluations/{evaluation_id}` | any authenticated user | `evaluation_id`, `project_id`, `release_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `get_projects_project_id_releases_release_id_evaluations_evaluation_id` |
| `GET` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/releases/{release_id}/evidence` | any authenticated user | `project_id`, `release_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `get_projects_project_id_releases_release_id_evidence` |
| `GET` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/releases/{release_id}/operations` | any authenticated user | `project_id`, `release_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `get_projects_project_id_releases_release_id_operations` |
| `POST` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/releases/{release_id}/operations` | `caliber.operator` | `project_id`, `release_id` | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_projects_project_id_releases_release_id_operations`; request body documented in OpenAPI |
| `GET` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/releases/{release_id}/operations/{operation_id}` | any authenticated user | `operation_id`, `project_id`, `release_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `get_projects_project_id_releases_release_id_operations_operation_id` |
| `POST` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/releases/{release_id}/operations/{operation_id}:apply` | `caliber.operator` | `operation_id`, `project_id`, `release_id` | `400`, `401`, `403`, `404` | `operationId`: `post_projects_project_id_releases_release_id_operations_operation_id_apply` |
| `POST` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/releases/{release_id}/operations/{operation_id}:cancel-expired` | `caliber.operator` | `operation_id`, `project_id`, `release_id` | `400`, `401`, `403`, `404` | `operationId`: `post_projects_project_id_releases_release_id_operations_operation_id_cancel_expired` |
| `POST` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/releases/{release_id}/operations/{operation_id}:observe` | `caliber.operator` | `operation_id`, `project_id`, `release_id` | `400`, `401`, `403`, `404` | `operationId`: `post_projects_project_id_releases_release_id_operations_operation_id_observe` |
| `POST` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/releases/{release_id}/quality-signoff` | any authenticated user | `project_id`, `release_id` | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_projects_project_id_releases_release_id_quality_signoff`; request body documented in OpenAPI |
...
| `GET` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/source/connection` | any authenticated user | `project_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `get_projects_project_id_source_connection` |
| `PUT` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/source/connection` | `caliber.operator` | `project_id` | `201`, `400`, `401`, `403`, `404` | `operationId`: `put_projects_project_id_source_connection`; request body documented in OpenAPI |
| `POST` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/source/connection:reconcile-deliveries` | `caliber.operator` | `project_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `post_projects_project_id_source_connection_reconcile_deliveries` |
| `POST` | `/ajax-api/2.0/mlflow/caliber/projects/{project_id}/source/connection:revoke` | `caliber.operator` | `project_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `post_projects_project_id_source_connection_revoke` |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/prompts` | project role (`resource.write.runtime`) | — | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_prompts`; request body documented in OpenAPI |
...
| `DELETE` | `/ajax-api/2.0/mlflow/caliber/prompts/{name}` | project role (`resource.write.runtime`) | `name` | `200`, `400`, `401`, `403`, `404` | `operationId`: `delete_prompts_name` |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/prompts/{name}/versions` | project role (`resource.write.runtime`) | `name` | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_prompts_name_versions`; request body documented in OpenAPI |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/skills` | project role (`resource.write.runtime`) | — | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_skills`; request body documented in OpenAPI |
| `POST` | `/ajax-api/2.0/mlflow/caliber/skills/import-package` | project role (`resource.write.runtime`) | — | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_skills_import_package`; request body documented in OpenAPI |
| `POST` | `/ajax-api/2.0/mlflow/caliber/skills/import-package.zip` | project role (`resource.write.runtime`) | — | `200`, `400`, `401`, `403`, `404` | `operationId`: `post_skills_import_package_zip` |
...
| `PATCH` | `/ajax-api/2.0/mlflow/caliber/skills/{skill_id}` | project role (`resource.write.runtime`) | `skill_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `patch_skills_skill_id`; request body documented in OpenAPI |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/tools` | project role (`resource.write.runtime`) | — | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_tools`; request body documented in OpenAPI |
...
| `PATCH` | `/ajax-api/2.0/mlflow/caliber/tools/{tool_id}` | project role (`resource.write.runtime`) | `tool_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `patch_tools_tool_id`; request body documented in OpenAPI |
| `POST` | `/ajax-api/2.0/mlflow/caliber/tools/{tool_id}/archive` | project role (`resource.write.runtime`) | `tool_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `post_tools_tool_id_archive`; request body documented in OpenAPI |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/workflows` | project role (`resource.write.runtime`) | — | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_workflows`; request body documented in OpenAPI |
| `POST` | `/ajax-api/2.0/mlflow/caliber/workflows/import` | project role (`resource.write.runtime`) | — | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_workflows_import`; request body documented in OpenAPI |
...
| `DELETE` | `/ajax-api/2.0/mlflow/caliber/workflows/{workflow_id}` | project role (`resource.write.runtime`) | `workflow_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `delete_workflows_workflow_id` |
...
| `PATCH` | `/ajax-api/2.0/mlflow/caliber/workflows/{workflow_id}` | project role (`resource.write.runtime`) | `workflow_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `patch_workflows_workflow_id`; request body documented in OpenAPI |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/eval-datasets` | project role (`resource.write.evidence`) | — | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_eval_datasets`; request body documented in OpenAPI |
...
| `PATCH` | `/ajax-api/2.0/mlflow/caliber/eval-datasets/{dataset_id}` | project role (`resource.write.evidence`) | `dataset_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `patch_eval_datasets_dataset_id`; request body documented in OpenAPI |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/eval-datasets/{dataset_id}/examples` | project role (`resource.write.evidence`) | `dataset_id` | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_eval_datasets_dataset_id_examples`; request body documented in OpenAPI |
| `POST` | `/ajax-api/2.0/mlflow/caliber/eval-datasets/{dataset_id}/examples/from-trace` | project role (`resource.write.evidence`) | `dataset_id` | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_eval_datasets_dataset_id_examples_from_trace`; request body documented in OpenAPI |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/judges` | project role (`resource.write.evidence`) | — | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_judges`; request body documented in OpenAPI |
...
| `PATCH` | `/ajax-api/2.0/mlflow/caliber/judges/{judge_id}` | project role (`resource.write.evidence`) | `judge_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `patch_judges_judge_id`; request body documented in OpenAPI |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/knowledge-bases/{knowledge_base_id}/baseline` | project role (`resource.write.runtime`) | `knowledge_base_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `post_knowledge_bases_knowledge_base_id_baseline`; request body documented in OpenAPI |
| `POST` | `/ajax-api/2.0/mlflow/caliber/knowledge-bases/{knowledge_base_id}/calibrate` | project role (`resource.execute`) | `knowledge_base_id` | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_knowledge_bases_knowledge_base_id_calibrate`; request body documented in OpenAPI |
| `POST` | `/ajax-api/2.0/mlflow/caliber/knowledge-bases/{knowledge_base_id}/rollback` | project role (`resource.write.runtime`) | `knowledge_base_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `post_knowledge_bases_knowledge_base_id_rollback` |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/knowledge-bases/{knowledge_base_id}/versions` | project role (`resource.write.runtime`) | `knowledge_base_id` | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_knowledge_bases_knowledge_base_id_versions`; request body documented in OpenAPI |
| `POST` | `/ajax-api/2.0/mlflow/caliber/knowledge-bases/{knowledge_base_id}/versions/{version_id}/activate` | project role (`resource.write.runtime`) | `knowledge_base_id`, `version_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `post_knowledge_bases_knowledge_base_id_versions_version_id_activate` |
...
| `PATCH` | `/ajax-api/2.0/mlflow/caliber/openapi-integrations/{integration_id}/dependencies/{dependency_id}` | project role (`resource.write.runtime`) | `dependency_id`, `integration_id` | `400`, `401`, `403`, `404` | `operationId`: `patch_openapi_integrations_integration_id_dependencies_dependency_id`; request body documented in OpenAPI |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/openapi-integrations/{integration_id}/import` | project role (`resource.write.runtime`) | `integration_id` | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_openapi_integrations_integration_id_import`; request body documented in OpenAPI |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/openapi-integrations/{integration_id}/reimport` | project role (`resource.write.runtime`) | `integration_id` | `400`, `401`, `403`, `404` | `operationId`: `post_openapi_integrations_integration_id_reimport` |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/openapi-integrations/{integration_id}/tool-drafts/generate` | project role (`resource.write.runtime`) | `integration_id` | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_openapi_integrations_integration_id_tool_drafts_generate`; request body documented in OpenAPI |
...
| `PATCH` | `/ajax-api/2.0/mlflow/caliber/openapi-integrations/{integration_id}/tool-drafts/{draft_id}` | project role (`resource.write.runtime`) | `draft_id`, `integration_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `patch_openapi_integrations_integration_id_tool_drafts_draft_id`; request body documented in OpenAPI |
| `POST` | `/ajax-api/2.0/mlflow/caliber/openapi-integrations/{integration_id}/tool-drafts/{draft_id}/preview` | project role (`resource.execute`) | `draft_id`, `integration_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `post_openapi_integrations_integration_id_tool_drafts_draft_id_preview`; request body documented in OpenAPI |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/knowledge-base-versions/{version_id}/age-sync` | project role (`resource.write.runtime`) | `version_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `post_knowledge_base_versions_version_id_age_sync` |
