...
| `POST` | `/ajax-api/2.0/mlflow/caliber/openapi-integrations` | `caliber.admin`, `caliber.operator` | — | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_openapi_integrations`; request body documented in OpenAPI |
...
| `PATCH` | `/ajax-api/2.0/mlflow/caliber/openapi-integrations/{integration_id}` | `caliber.admin`, `caliber.operator` | `integration_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `patch_openapi_integrations_integration_id`; request body documented in OpenAPI |
| `POST` | `/ajax-api/2.0/mlflow/caliber/openapi-integrations/{integration_id}/archive` | `caliber.admin`, `caliber.operator` | `integration_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `post_openapi_integrations_integration_id_archive`; request body documented in OpenAPI |
...
| `PATCH` | `/ajax-api/2.0/mlflow/caliber/openapi-integrations/{integration_id}/dependencies/{dependency_id}` | `caliber.admin`, `caliber.operator` | `dependency_id`, `integration_id` | `400`, `401`, `403`, `404` | `operationId`: `patch_openapi_integrations_integration_id_dependencies_dependency_id`; request body documented in OpenAPI |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/openapi-integrations/{integration_id}/import` | `caliber.admin`, `caliber.operator` | `integration_id` | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_openapi_integrations_integration_id_import`; request body documented in OpenAPI |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/openapi-integrations/{integration_id}/reimport` | `caliber.admin`, `caliber.operator` | `integration_id` | `400`, `401`, `403`, `404` | `operationId`: `post_openapi_integrations_integration_id_reimport` |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/openapi-integrations/{integration_id}/tool-drafts/generate` | `caliber.admin`, `caliber.operator` | `integration_id` | `201`, `400`, `401`, `403`, `404` | `operationId`: `post_openapi_integrations_integration_id_tool_drafts_generate`; request body documented in OpenAPI |
...
| `PATCH` | `/ajax-api/2.0/mlflow/caliber/openapi-integrations/{integration_id}/tool-drafts/{draft_id}` | `caliber.admin`, `caliber.operator` | `draft_id`, `integration_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `patch_openapi_integrations_integration_id_tool_drafts_draft_id`; request body documented in OpenAPI |
| `POST` | `/ajax-api/2.0/mlflow/caliber/openapi-integrations/{integration_id}/tool-drafts/{draft_id}/preview` | `caliber.admin`, `caliber.operator` | `draft_id`, `integration_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `post_openapi_integrations_integration_id_tool_drafts_draft_id_preview`; request body documented in OpenAPI |
...
| `POST` | `/ajax-api/2.0/mlflow/caliber/openapi-integrations/{integration_id}/validate-credential-binding` | `caliber.admin`, `caliber.operator` | `integration_id` | `200`, `400`, `401`, `403`, `404` | `operationId`: `post_openapi_integrations_integration_id_validate_credential_binding`; request body documented in OpenAPI |
| `POST` | `/ajax-api/2.0/mlflow/caliber/openapi-integrations/{integration_id}/validate-spec-source` | `caliber.admin`, `caliber.operator` | `integration_id` | `400`, `401`, `403`, `404` | `operationId`: `post_openapi_integrations_integration_id_validate_spec_source`; request body documented in OpenAPI |
