...
| Projects (`projects`) | `ga` | `64` | Partial (33/64) | `client.projects`, `client.projects.files`, `client.projects.rework_tasks` | Project records, project storage visibility, uploads, folders, downloads, and scoped rework-task recovery. |
...
| [Projects (`projects`)](#projects-projects) | `64` | `52` |
...
64 operation(s) across 52 route path(s).
