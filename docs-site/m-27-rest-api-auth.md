<!-- Generated by docs-site/build-docs.mjs from docs/api/auth.md. Do not edit this file: edit the source and re-run the build (caliber/caliber-ui: npm run sync:docs). -->
